...
function App() {
  ...
  return (
    <div className="NFTs">
      ...
      <p className="website__rights">Website built by<a href="/Users/loosebucks/Desktop/projects/simple-hash-nfts/birdEye.html" target="_blank" rel="noopener noreferrer" className="burnt"> @burntaftermint.sol</a></p>
      {collections ? (
