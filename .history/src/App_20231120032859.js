        ...
        <ul>
          {collections.map((collection, index) => (
            <li key={index}>
              ...
              <strong>Floor Price:</strong> {console.log(collection.floor_prices), collection.floor_prices && collection.floor_prices.length > 0 ? `${collection.floor_prices[0].value / 1e9} SOL` : 'N/A'}<br />
