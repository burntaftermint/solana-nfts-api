...
function App() {
  ...
  return (
    <div className="NFTs">
      ...
      <h3>This is a top 100 list of Solana NFTs in terms of volume over the last 24 hours. The list is generated using the Simple Hash API and is updated daily.</h3>
