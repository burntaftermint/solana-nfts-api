...
import burntaftermintImage from '/Users/loosebucks/Desktop/projects/tensor-tracker/images/burntaftermint.png';
...
function App() {
  ...
  return (
    <div className="NFTs">
      ...
      {/* Add the image above the paragraph */}
      <img src={burntaftermintImage} alt="Burntaftermint Logo" className="burntaftermint-logo" />
