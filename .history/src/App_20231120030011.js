        ...
        <ul>
          {collections.map((collection, index) => (
            <li key={index}>
              ...
              <strong>Floor Price:</strong> {collection.floor_prices?.find(price => price.marketplace_id === 'magiceden')?.value !== undefined
  ? `${collection.floor_prices.find(price => price.marketplace_id === 'magiceden').value / 1e9} SOL (USD ${collection.floor_prices.find(price => price.marketplace_id === 'magiceden').value_usd_cents / 100})`
  : 'N/A'}<br />
