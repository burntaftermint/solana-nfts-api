...
function App() {
  ...
  <li key={index}>
    ...
    <strong>Floor Price (Magic Eden, SOL):</strong> {console.log(collection.floor_prices)} {collection.floor_prices?.find(price => price.marketplace_id === 'magiceden')?.value / 1e9 || 'N/A'} SOL<br />
<strong>Floor Price (Tensor, SOL):</strong> {collection.floor_prices?.find(price => price.marketplace_id === 'tensor')?.value / 1e9 || 'N/A'} SOL<br />
