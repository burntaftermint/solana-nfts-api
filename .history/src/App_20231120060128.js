...
function App() {
  ...
  return (
    <div className="NFTs">
      ...
      <h3>This is a top 50 list of Solana NFTs in terms of volume over the last 24 hours. The list is generated using the Magic Eden API and is updated daily.</h3>
      {collections ? (
