...
function App() {
  ...
  <li key={index}>
    ...
    <strong>Collection URL:</strong> <a href={collection.marketplace_pages?.find(page => page.marketplace_id === 'magiceden')?.collection_url} target="_blank" rel="noopener noreferrer">{collection.marketplace_pages?.find(page => page.marketplace_id === 'magiceden')?.collection_url || 'N/A'}</a><br />
