...
function App() {
  ...
  collection.floor_prices.find((price) => price.marketplace_id === 'magiceden')?.value !== undefined
    ? `${collection.floor_prices.find((price) => price.marketplace_id === 'magiceden').value / 1e9} SOL`
    : 'N/A'
}<br />
